...
private:
    const std::string DATA = "../Practica3IG/data/";
...
private:
   ...
   *                        1: Cubo 2: Tetraedro 3:Figura PLY 4: Figura Revolución 5: Objeto Jerárquico
   */
  int who_is_visible;
   ...
   * @param index: Índice: 1: Cubo 2: Tetraedro 3: Figura PLY 4: Figura Revolución 5: Objeto Jerárquico
   */
