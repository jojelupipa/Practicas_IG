...
_window::_window()
{
  ...
  // /// Añadiendo widget lateral controlador/interfaz
  interfaz = new Interface(this);
  interfaz->setSizePolicy(QSizePolicy::Fixed,QSizePolicy::Expanding);
  interfaz->setFixedWidth(300);
  interfaz->setWidget(GL_widget);
  Horizontal_frame->addWidget(interfaz);
  // ///
...
/*
  ...
  Ply_menu->addAction("Hormiga");
  connect(Ply_menu,SIGNAL(triggered(QAction*)),this,SLOT(loadAnt);
  */
  /*
...
*/
  ...
  setWindowTitle(tr("Práctica Informática Gráfica (Jesús Sánchez de Lechina)"));
  resize(1000,800);
