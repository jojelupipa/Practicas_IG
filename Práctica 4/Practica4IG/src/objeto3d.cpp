...
void Objeto3D::DrawLightFlat(int material,int angulo1, int angulo2, double position1){
    ...
    if(angulo1 >= 0){                   // Controlamos la disposición de la luz
        ...
        glRotatef(0, 1,0,0); // Giro de la luz sobre X
...
void Objeto3D::DrawLightSmooth(int material,int angulo1, int angulo2, double position1){
